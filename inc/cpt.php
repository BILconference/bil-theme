...
function cpt_organizer() {
	...
	$labels = array(
		'name'                => _x( 'Organizer', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'Organizer', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Organizers', 'text_domain' ),
		'name_admin_bar'      => __( 'Organizers', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Item:', 'text_domain' ),
		'all_items'           => __( 'All Items', 'text_domain' ),
		'add_new_item'        => __( 'Add New Item', 'text_domain' ),
		'add_new'             => __( 'Add New', 'text_domain' ),
	...
	$args = array(
		'label'               => __( 'organizer', 'text_domain' ),
		'description'         => __( 'BIL Organizers', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'page-attributes' ),
		'hierarchical'        => false,
		'public'              => true,
...
// Hook into the 'init' action
add_action( 'init', 'cpt_organizer', 0 );
...
function cpt_stream() {
	...
	$labels = array(
		'name'                => _x( 'Stream', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'Stream', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Streams', 'text_domain' ),
		'name_admin_bar'      => __( 'Stream', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Item:', 'text_domain' ),
		'all_items'           => __( 'All Items', 'text_domain' ),
		'add_new_item'        => __( 'Add New Item', 'text_domain' ),
		'add_new'             => __( 'Add New', 'text_domain' ),
	...
	$args = array(
		...
		'description'         => __( 'Stream', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'page-attributes' ),
		'hierarchical'        => false,
		'public'              => true,
