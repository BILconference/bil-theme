...
function cpt_be() {
	...
	$labels = array(
		'name'                => _x( 'BESponsor', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'BESponsor', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'BESponsors', 'text_domain' ),
		'name_admin_bar'      => __( 'BESponsors', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Item:', 'text_domain' ),
		'all_items'           => __( 'All Items', 'text_domain' ),
		'add_new_item'        => __( 'Add New Item', 'text_domain' ),
		'add_new'             => __( 'Add New', 'text_domain' ),
	...
	$args = array(
		'label'               => __( 'be', 'text_domain' ),
		'description'         => __( 'BIL EVENT', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( ),
		'hierarchical'        => false,
		'public'              => true,
	...
	register_post_type( 'bil-event', $args );

}

// Hook into the 'init' action
add_action( 'init', 'cpt_be', 0 );
